    ...
    <mu-flex class="detial-info" direction="column">
      ...
      <mu-flex class="actions-wrapper">
        <mu-button
          ...
          :to="`/user/add_contact?liteam=${userInfo.curaNumber}`"
      ...
      <div class="mu-info-wrapper">
        <div class="border1px--bottom info-wrapper">
          <div class="main-wrapper">
            ...
            <span class="cura">Liteam: {{ userInfo.curaNumber }}</span>
          </div>
          <mu-flex class="main-wrapper" align-items="center">
            <mu-badge class="sex" color="primary" :content="userInfo.sex"></mu-badge>
...
export default {
  ...
  methods: {
    async getUserInfo() {
      const curaNumber = this.$route.query.liteam;
    ...
    goMore() {
      this.$router.push(`/user/detial/contact_settings?liteam=${this.userInfo.curaNumber}`)
    },
    cancelCommend() {
